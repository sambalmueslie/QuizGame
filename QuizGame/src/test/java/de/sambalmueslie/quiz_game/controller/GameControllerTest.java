...
public class GameControllerTest {
	...
	public void setUp() throws Exception {
		...
		model.addQuestion(createQuestion("Question Level 1", "a", "b", "c", "d", 1, 'a'));
		model.addQuestion(createQuestion("Question Level 2", "a", "b", "c", "d", 2, 'a'));
		model.addQuestion(createQuestion("Question Level 3", "a", "b", "c", "d", 3, 'a'));
		model.addQuestion(createQuestion("Question Level 4", "a", "b", "c", "d", 4, 'a'));
		model.addQuestion(createQuestion("Question Level 5", "a", "b", "c", "d", 5, 'a'));
		model.addQuestion(createQuestion("Question Level 6", "a", "b", "c", "d", 6, 'a'));
		model.addQuestion(createQuestion("Question Level 7", "a", "b", "c", "d", 7, 'a'));
		model.addQuestion(createQuestion("Question Level 8", "a", "b", "c", "d", 8, 'a'));
		model.addQuestion(createQuestion("Question Level 9", "a", "b", "c", "d", 9, 'a'));
		model.addQuestion(createQuestion("Question Level 10", "a", "b", "c", "d", 10, 'a'));
		model.addQuestion(createQuestion("Question Level 11", "a", "b", "c", "d", 11, 'a'));
		model.addQuestion(createQuestion("Question Level 12", "a", "b", "c", "d", 12, 'a'));
		model.addQuestion(createQuestion("Question Level 13", "a", "b", "c", "d", 13, 'a'));
		model.addQuestion(createQuestion("Question Level 14", "a", "b", "c", "d", 14, 'a'));
		model.addQuestion(createQuestion("Question Level 15", "a", "b", "c", "d", 15, 'a'));
